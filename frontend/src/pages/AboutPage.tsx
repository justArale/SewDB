    ...
    <div className="aboutPage">
      <div className="about-content">
        ...
        <p className="mainFont">
          ...
          and a whole lot of passion stitched into one. To respect copyright
          rules, SewDB is a private space. You'll need to log in to access
          everything, but once you're in, feel free to explore and get inspired!
        </p>
      </div>
